...
//    }
    ...
    @Bean
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws SQLException {
        ...
        try {
            ...
            //properties.load(this.getClass().getClassLoader().getResourceAsStream("properties/mysql.properties"));
    ...
    protected String initDatabaseType(DataSource dataSource) throws SQLException {
